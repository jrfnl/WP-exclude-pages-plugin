...
This plugin adds a checkbox, _include this page in menus_, uncheck this to exclude pages from the page navigation that users see on your site.


== Description ==

This plugin adds a checkbox, _include this page in menus_, which is checked by default. If you uncheck
...
* Dutch - [Jrf, Advies en zo](http://adviesenzo.nl/)
* Italian - [Gianni Diurno](http://gidibao.net/index.php/portfolio/)
* Polish - [Pawel, Siedlecki Portal Informacyjnie Najlepszy](http://www.spin.siedlce.pl)
* German - [Meini, Utech Computer Solutions](http://utechworld.com)

There's only a few phrases to translate, so please send in your translations.
...
* [Phantom theme](http://wordpress.org/extend/themes/phantom)
...
* ENHANCEMENT: You can now in-/exclude a page through the quick edit box on the pages overview page
* ENHANCEMENT: The plugin will now properly remove it's settings when you uninstall it
* FIX: limited the loading of css and js to the relevant admin pages
* LOCALISATION: Updated .POT file available
* LOCALISATION: Dutch translation courtesy of [Jrf, Advies en zo](http://adviesenzo.nl/)
